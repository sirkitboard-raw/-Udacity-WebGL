...
function createStairs() {
    ...
    for(var i = 0; i<7; i++) {
        ...
        stepMesh.position.y = ((verticalStepHeight + stepThickness) * i) + verticalStepHeight/2;	// half of height: put it above ground plane
        ...
        stepMesh.position.y = ((verticalStepHeight + stepThickness) * i) + stepThickness/2 + verticalStepHeight;
        // Push step forward by half the depth, minus half the vertical step's thickness
        stepMesh.position.z = (horizontalStepDepth - stepThickness) * i + horizontalStepDepth/2 - stepHalfThickness;
        scene.add( stepMesh );
    }
}
