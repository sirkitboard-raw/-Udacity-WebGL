...
function createBody() {
    ...
    bodyCyl.position.x = 0;
    bodyCyl.position.y = 160 + 390/2;
    bodyCyl.position.z = 0;
    scene.add(bodyCyl);
}
...
function createHead() {
    ...
    hatBase.position.y = 160 + 390 + 40 + 5;
    ...
    hatTop.position.x = 0;
    hatTop.position.y = 160 + 390 + 50 + 35;
    hatTop.position.z = 0;
    scene.add(hatTop);
}
